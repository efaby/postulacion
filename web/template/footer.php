...
<script src="<?php echo PATH_CSS . '/../js/jquery.min.js';?>"></script>
		...
		<script src="<?php echo PATH_CSS . '/../plugins/nicescroll/jquery.nicescroll.js';?>"></script>
		<script src="<?php echo PATH_CSS . '/../plugins/slimscroll/jquery.slimscroll.min.js';?>"></script>
		<script src="<?php echo PATH_CSS . '/../plugins/backstretch/jquery.backstretch.min.js';?>"></script>
</div>
